    ...
    if (data) {
        Object.keys(data).forEach((key) => {
            ...
            row.innerHTML = `
                ...
                <td style="padding: 10px;">${item.content.substring(0, 40)}...</td>
                <td style="padding: 10px;">
                    <button onclick="deleteNews('${key}')" style="background-color: #dc3545; color: white; border: none; padding: 5px 10px; border-radius: 4px; cursor: pointer;">ሰርዝ</button>
                </td>
            `;
